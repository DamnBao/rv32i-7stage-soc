...
// Integration testbench — full SoC (soc_top) with external SFR peripherals.
// Halt mechanism: program writes x31=1 (pass) or x31=0 (fail), then EBREAK.
//
// Runtime args:
...
module tb_pipeline_cpu;
    ...
    // ── Reset outputs from soc_top ────────────────────────────────────────
    logic rst_cpu_n_o, rst_ahb_n_o;

    // ── AXI Slave 0 (base=0x2000_0000) ──────────────────────────────────
    ...
    // ── External AXI SFR peripherals (3×) ───────────────────────────────
    ...
    // ── External AHB SFR peripherals (3×) ───────────────────────────────
